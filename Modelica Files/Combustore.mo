within ;
model Combustore "Gas turbine combustion chamber"
...
public
  ...
  RealInput LHVfuel_in
    annotation (Placement(transformation(extent={{-100,-70},{-80,-50}})));

  // Internal variable (linked to input)
  SI.SpecificEnergy LHVfuel "Fuel lower heating value";
