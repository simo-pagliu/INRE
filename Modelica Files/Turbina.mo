within ;
model Turbina "Combustion turbine for CICO and Barilla plants"
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.OutputReal PuissanceMeca
    annotation (Placement(transformation(extent={{100,-44},{108,-36}}, rotation=
           0)));
  Modelica.Blocks.Interfaces.RealInput LHV_input annotation (Placement(
        transformation(extent={{-12,92},{6,110}}), iconTransformation(extent={{
            -12,92},{6,110}})));
equation
  ...
  connect(LHV_input, chambreCombustionTAC.LHVfuel_in) annotation (Line(points={
          {-3,101},{-28,101},{-28,41.4},{-22.5,41.4}}, color={0,0,127}));
