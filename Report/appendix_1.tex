This appendix includes the code for the Modelica components developed from scratch. All scripts for preprocessing, post-processing, and overall data analysis, as well as the economic assessment, can be found in the GitHub repository \url{github.com/simo-pagliu/INRE}.
